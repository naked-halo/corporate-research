label scene9:
    ...
    r "Maybe a little. But you did tell me you like my big breasts, right to my face."
    ...
    r "You know how much work like this costs outside? It's like, six grand."
    ...
    r "Ha. Do you really have to ask?"
    #timeskip
    ...
    "It doesn't take long for the new 'male' of the group to mount her partner."
    r "That didn't take long. Did you see the look on her face when her dick popped out?"
    show lily smirk
    l "Indeed. Was I really like that when I took the pill?"
    r "You had a little more control over things, I think."
    r "So, what's next?"
    show lily neutral
    l "Well, a pregnancy might not happen right away, so they'll have to come back here for a few more days."
