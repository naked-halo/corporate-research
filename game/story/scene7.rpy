label scene7:
    ...
    l "We helped humans move out and into more suitable homes and made sure they could surivive."
    l "Eventually, humans settled into their new homes and angels were done with their first major project."
    ...
    r "I'm lactating?!?"
    l "So it does work! It must have needed some additional protein and fat in your system to get going."
    l "Fascinating..."
    r "Now's not the time, Lily! Help me out here!"
    "Lily quickly tries to wipe me down, but it's no use."
    "My nipples are still leaking like a drippy faucet, so all we can do is stuff a few napkins under my shirt as we pay and rush out the door."
